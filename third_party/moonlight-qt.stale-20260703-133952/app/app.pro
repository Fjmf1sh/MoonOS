...
# Moon OS fork integration: when the moon/ directory has been dropped into
# app/ (by scripts/prepare-fork.sh in the Moon OS repo), build Moon Shell.
exists(moon/moon.pri) {
    include(moon/moon.pri)
}
